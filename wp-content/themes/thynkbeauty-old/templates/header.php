...
<!--                    <img src="--><?php //echo esc_url($virtue['x2_virtue_logo_upload']['url']);?><!--" alt="--><?php //bloginfo('name');?><!--" class="kad-retina-logo" style="max-height:--><?php //echo esc_attr($virtue['x1_virtue_logo_upload']['height']);?><?php //} ?>
<!--                  </div>-->
<!--                --><?php //} else { 
